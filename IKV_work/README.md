...
- Editable matter title, opponent identity, court data, and case classification.
...
3. Move a case `preparation -> process -> archive`; confirm court fields are optional and archive location is required.
...
- **Փուլ և արխիվ** ներդիրի **Խմբագրել գործի տվյալները** կոճակով փոխեք գործի տեսակը, առարկան, հակառակ կողմին կամ դատական տվյալները։
- Դատական համարը, դատարանը, ատյանը և դատավորը պարտադիր չեն և կարող են լրացվել ավելի ուշ։
- Արխիվային գործը կարող եք արագ գրանցել միայն անունով, իսկ պահպանման տեղը լրացնել ավելի ուշ։
...
- Բազմահատոր արխիվային գործի համար **Փուլ և արխիվ** ներդիրում ավելացրեք յուրաքանչյուր հատորը և դրա առանձին պահպանման տեղը։
